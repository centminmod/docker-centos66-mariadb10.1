...
RUN yum -y install epel-release wget nano which perl-DBI python-setuptools && yum -y install python-meld3 && rm -rf /var/cache/*; echo "" > /var/log/yum.log && easy_install pip && easy_install supervisor && easy_install supervisor-stdout
